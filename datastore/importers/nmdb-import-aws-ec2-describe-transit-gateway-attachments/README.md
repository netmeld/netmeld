...
`aws ec2 describe-vpc-peering-connections` command.
...
```
nmdb-import-aws-ec2-describe-vpc-peering-connections data.json
```
...
```
... | nmdb-import-aws-ec2-describe-vpc-peering-connections data.json --pipe
```
